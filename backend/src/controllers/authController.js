...
const REFRESH_TOKEN_TTL = 60 * 60 * 1000; // 1 giờ, thời gian sống của refresh token, sau thời gian này sẽ hết hạn và không thể sử dụng để tạo access token mới nữa
