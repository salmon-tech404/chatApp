...
const PREVIEW_MESSAGES = [
  {
    id: 1,
    text: "Hey, dự án mới tiến độ thế nào rồi? 🚀",
    mine: false,
    time: "09:30",
  },
  {
    id: 2,
    text: "Đang hoàn thiện phần auth, sắp xong rồi!",
    mine: true,
    time: "09:31",
  },
  {
    id: 3,
    text: "Tuyệt vời! Design trông rất đẹp 🔥",
    mine: false,
    time: "09:32",
  },
];
        ...
        <div className={styles.mockupBody}>
          {PREVIEW_MESSAGES.map((msg) => (
            ...
            >
              ...
              <div
                className={`${styles.mockupBubble} ${msg.mine ? styles.mockupBubbleMine : ""}`}
              >
                {msg.text}
              </div>
    ...
    <section className={styles.hero}>
      ...
      <div className={styles.heroContent}>
        ...
        <h1 className={styles.heroTitle}>
          Kết nối mọi <span className='gradient-text'>người thân yêu</span>
          <br />
          mọi lúc mọi nơi
        </h1>

        <p className={styles.heroSubtitle}>
          Trò chuyện, chia sẻ khoảnh khắc và duy trì kết nối với bạn bè, gia
          đình dễ dàng hơn bao giờ hết với ChatApp.
        </p>
